            ...
            <div className="grid gap-4 p-4 lg:grid-cols-[1.6fr_1fr] lg:items-center">
              ...
              <div>
                ...
                <p className="mt-2 max-w-xl text-sm leading-6 text-slate-500">
                  View customer information, sales history, outstanding
                  balances, and complete ledger details from a centralized
                  dashboard.
                </p>
              </div>
              ...
              <div className="grid gap-4">
                {/* Phone */}
                <div className="rounded-lg border border-slate-200 bg-gradient-to-br from-slate-50 to-white p-2 transition-all duration-200 hover:border-teal-200 hover:shadow-sm">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 mb-4">
            {[
              ...
              },
              {
                ...
                bg: "bg-gradient-to-tr from-teal-200 via-teal-50 to-white",
